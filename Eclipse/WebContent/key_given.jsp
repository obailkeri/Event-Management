  ...
  <body>
    ...
    <header class="header">
      <nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow">
        ...
        <a href="index.html" class="navbar-brand font-weight-bold text-uppercase text-base">Event Manager</a>
                ...
                <div class="card">
                  ...
                  <div class="card-body">                           
                    <table class="table table-striped card-text">
                      ...
                      try
                      {
                    	  String sql=" select distinct e.event_id,e.event_name,e.username,e.status_level,s.event_id,s.status_level from event_ledger e inner join slots_and_details s on e.event_id=s.event_id where e.status_level=5 and s.status_level=2";
                        ...
                        %>
		                          ...
		                          <td class="text-center">No Approval</td>
		                          <%} else%>
		                          <%if(rs.getInt(4)==3){ %>
		                        ...
		                        <form action="key_given_detail.jsp" method =post>
		                         <td><button class="btn-sm btn-primary" value ="<%= rs.getInt(1)  %>" name="btn">View</button></a></td>
		                         </form>
