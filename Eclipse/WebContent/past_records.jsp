...
<%
    ...
    <div class="d-flex align-items-stretch">
              ...
              <div class="col-lg-12 mb-4">
                <div class="card">
                  <div class="card-header">
                    <h6 class="text-uppercase mb-0">Past Records</h6>
                  </div>
                  <div class="card-body">                           
      ...
      try
      {
    	  ...
    	  String sql="select distinct e.event_id,e.event_name,e.username,e.status_level,e.description,e.start_date,e.end_date,s.event_id,s.status_level from event_ledger e inner join slots_and_details s on e.event_id=s.event_id where e.status_level=6 and s.status_level=3";
      ...
      %>
                       <tr class="text-center">
		                         ...
		                         <form action="past_detail.jsp" method="post">
