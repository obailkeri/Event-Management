  ...
  <body>
	...
	<%
      ...
      try
      {
    	  ...
    	  String sql="select distinct e.event_id,e.event_name,e.username,e.status_level,e.description,e.start_date,e.end_date,s.event_id,s.status_level from event_ledger e inner join slots_and_details s on e.event_id=s.event_id where e.status_level=5 and s.status_level=1 and e.event_id=?";
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <form id="room_book" method="" action="">
                      ...
                      <!-- <div class="form-group row justify-content-center">
                        <label class="col-md-12 form-control-label text-center"><p class="pt-1" style="font-size: 20px;"></p></label>
                      </div> -->
                     ...
                     <div class="row justify-content-center">
                        <div class="d-flex">
                          <button type="reset" class="btn btn-primary ml-4 mr-2 disabled" style="cursor: not-allowed;">Taken Back</button>
                    		<form action="Secops1" method="post">
	                        <button type="submit" class="btn btn-primary ml-2"  value ="<%= rs.getInt(1)  %>"name="btn2">Key Given</button>
	                      	</form>
