...
<%
    ...
    <header class="header">
      <nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow">
        ...
        <!-- For Side Bar Toggle -->Web Developer
              ...
              <div class="col-lg-12 mb-4">
                <div class="card">
                  <div class="card-header">
                    <h6 class="text-uppercase mb-0">Upcoming/Ongoing Events</h6>
                  </div>
                  <div class="card-body"> 
                    ...
                    <table class="table table-striped card-text">
                      ...
                      try
                      {
                    	  String sql=" select distinct e.event_id,e.event_name,e.username,e.status_level,s.event_id,s.status_level from event_ledger e inner join slots_and_details s on e.event_id=s.event_id where e.status_level=5 and s.status_level=1";
