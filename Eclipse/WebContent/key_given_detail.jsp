  ...
  <body>
    ...
    <div class="d-flex align-items-stretch">
          ...
          <li class="sidebar-list-item"><a href="#" data-toggle="collapse" data-target="#pages1" aria-expanded="false" aria-controls="pages" class="sidebar-link text-muted active"><i class="o-wireframe-1 mr-3 text-gray"></i><span>Keys Records</span></a>
            <div id="pages1" class="collapse">
              <ul class="sidebar-menu list-unstyled border-left border-primary border-thick">
                <li class="sidebar-list-item"><a href="key_given.jsp" class="sidebar-link text-muted pl-lg-5 active">Keys Given</a></li>
      ...
      try
      {
    	  ...
    	  String sql="select distinct e.event_id,e.event_name,e.username,e.status_level,e.description,e.start_date,e.end_date,s.event_id,s.status_level from event_ledger e inner join slots_and_details s on e.event_id=s.event_id where e.status_level=5 and s.status_level=2 and e.event_id=?";
            ...
            <div class="row">
              <div class="col-lg-12 mb-4">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <h5><span>Approved by HOD</span></h5>
                    <br>
                  ...
                  <div class="card-body">
                    <form id="room_book" method="" action="">
                      ...
                      <div class="row justify-content-center">
                        <div class="d-flex">
                          <form action="Secops2" method="post">
                          <button type="submit" class="btn btn-primary ml-4 mr-2"  value ="<%= rs.getInt(1)  %>"name="btn2">Taken Back</button>
                          </form>
                          <button type="submit" class="btn btn-primary ml-2 disabled" style="cursor: not-allowed;">Key Given</button>
                        </div>
                      </div>
					 <%
							  }
