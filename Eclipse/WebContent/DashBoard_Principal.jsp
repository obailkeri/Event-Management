                  ...
                  <div class="card-header">
                    <div class="row justify-content-center">
                      ...
                      <div class="col-md-5 text-center">
                        <a href="Princi_prop.jsp"><h6 class="text-uppercase mb-0">View All</h6></a>
                      </div>
                    </div>
                  </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="card">
                  ...
                  <div class="card-header">
                    <h6 class="text-uppercase mb-0"><a href="Princi_past_events.jsp">Past Events</a></h6>
                  </div>
              ...
              <div class="col-lg-6">
                <div class="card">
                  ...
                  <div class="card-header">
                    <h6 class="text-uppercase mb-0"><a href="Princi_upcoming.jsp">Upcoming/Ongoing Events</a></h6>
                  </div>
                         ...
                         <%
			                  ...
			                  <% 	
		                  				...
		                  				{	
		                  					...
		                  					%>
		                  					<tr  class="text-center">
					                          <th scope="row">  <c:set var="count6" value="${count6 + 1}" scope="page"/> ${count6} </th>
				                  ...
				                  %>			
						                  		<tr bgcolor="#FFF000"  class="text-center " >
						                          <th bgcolor="#FFF000" scope="row">  <c:set var="count5" value="${count5 + 1}" scope="page"/> ${count5} </th>
